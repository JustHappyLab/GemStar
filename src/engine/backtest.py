...
def run_backtest(daily_df, signals, rankings, initial_capital=100000, trade_dates=None, cost_multiplier=1.0) -> dict:
    """Day-by-day backtest."""
    ...
    for date in dates:
        ...
        for code in list(holdings):
            ...
            if target_shares < held:
                ...
                cost = calc_trade_cost(price, sell_shares, "sell", date, cost_multiplier)
        ...
        for code, tgt in target.items():
            ...
            if tgt > held:
                ...
                buy_shares = tgt - held
                price = open_prices.get(code, 0)
                buy_shares, cost = _fit_buy_shares_to_cash(price, buy_shares, cash, date, cost_multiplier)
                if buy_shares == 0:
                    continue
